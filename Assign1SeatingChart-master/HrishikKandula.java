...
/**
 * Write a description of class HrishikKandula here.
 * 
 * @author (your name) 
...
{
    /**
     * Act - do whatever the HrishikKandula wants to do. This method is called whenever
    ...
    public void act() 
    {
        ...
        if(Greenfoot.mouseClicked(this)){
            if (sitting){
                ...
                myHobby("I like to talk about cheese");
